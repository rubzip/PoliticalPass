 ...
 * This is not exactly a problem, but our dataset is completly localized in Spain, so model is going to predict left-wing and right-wing when the tweet is refered to Spanish topics.
